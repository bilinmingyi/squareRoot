...
export default {
  ...
  methods: {
    ...
    ...mapActions(['set_print_createTime', 'set_patient_info', 'set_order_seqno', 'init_recipe', 'init_recode', 'set_state_prop', 'set_recipe_help', 'change_curr_tab', 'set_cloud_shop', 'add_new_recipt', "set_record_prop"]),
    init() {
