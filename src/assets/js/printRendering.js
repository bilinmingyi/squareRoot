    ...
    switch (this.type) {
      case 'patientHistory':
        ...
        if (this.dataObj['$体格检查'] == '') {
          ...
          examination.info &&
            (examinatioStr += (examinatioStr ? '' : '') + examination.info)
        }
      ...
      case 'treatApply':
        ...
        break
      case 'registration':
        this.dataObj['$支付二维码'] = this.dataObj['$支付二维码']
          ? '<img src="' +
            this.dataObj['$支付二维码'] +
  ...
  this.render = function() {
    ...
    this.template.pageContent.header.forEach(function(line) {
      resultStr +=
        ...
        'min-height: 5px;padding-top: ' +
        self.mmTopx(line.paddingTop) +
        ';padding-bottom: ' +
        self.mmTopx(line.paddingBottom) +
        ';">'
          ...
          resultStr +=
            content.type == 'image'
              ...
              : '<div style="white-space: pre-wrap;line-height: 120%;flex: ' +
                ...
                content.fontWeight +
                ';"><span style="color: ' +
                (self.template.printType != 1 ? '#ffffff;' : 'inherit;') +
                '">' +
                content.key +
                '</span>' +
                content.value +
    ...
    this.fn(
      resultStr,
      this.template.pageWidth,
      this.template.pageHeight,
      this.template.pagePadding
    )
  }
  // 获取打印模板
  vue
